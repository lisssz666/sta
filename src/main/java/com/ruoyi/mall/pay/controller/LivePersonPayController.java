 ...
 */
@RestController
@RequestMapping("/liveperson/pay")
public class LivePersonPayController {
    ...
    public ResponseEntity<Map<String, String>> unifiedPayment(@RequestBody Map<String, Object> request) {
        try {
            ...
            String description = String.valueOf(request.getOrDefault("description", "直播服务费"));

            System.out.println("直播人员支付请求参数：" + request);
            System.out.println("code：" + code + "，金额：" + amount + "，订单号：" + outTradeNo + "，描述：" + description);

            // 3. 业务调用
            Map<String, String> paymentParams = livePersonPayService.getPaymentParams(code, amount, outTradeNo, description);
            ...
            // 4. 异常处理与返回
            System.err.println("直播人员支付下单失败：" + e.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> queryOrder(@RequestBody Map<String, Object> request) {
        try {
            ...
            Map<String, Object> orderInfo = livePersonPayService.queryOrder(outTradeNo, transactionId);
    ...
    public ResponseEntity<Map<String, Object>> refundOrder(@RequestBody Map<String, Object> request) {
        try {
            ...
            Map<String, Object> refundInfo = livePersonPayService.refundOrder(outTradeNo, transactionId, outRefundNo, amount);
